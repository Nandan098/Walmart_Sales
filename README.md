...
1️. <b>Environment Setup</b> <br>
      &nbsp; &bull; Tools Used: Visual Studio Code, Python, MySQL & PostgreSQL
      &nbsp; &bull; Created a well-structured workspace with organized folders to ensure smooth development, data handling, and version control throughout the project.
